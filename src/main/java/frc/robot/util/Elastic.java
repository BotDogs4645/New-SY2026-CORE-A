...
public final class Elastic {
  ...
  private static final StringPublisher notificationPublisher =
      notificationTopic.publish(PubSubOption.sendAll(true), PubSubOption.keepDuplicates(false));
  private static final StringSubscriber notificationSubscriber = notificationTopic.subscribe("");
